...
import typeisModule from 'type-is';
...
const typeis = typeisModule.is;
const getType = mimeTypesModule.contentType;
...
export default {
    ...
    */
    ...
    set body(val) {
        ...
        // no content
        if (null === val && typeof null === "undefined") {
        ...
        if ('function' == typeof val.pipe) {
            ...
            // overwriting
            if (null !== original && typeof original !== "undefined" && original !== val) this.remove('Content-Length');
    ...
    */
    ...
    get length() {
        ...
        if (null === len || typeof len === "undefined") {
            if (!body) return;
